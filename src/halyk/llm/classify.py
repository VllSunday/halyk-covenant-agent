...
OUTPUT_CONTRACT = "transaction-category-2"
...
- opex — прочие операционные расходы: маркетинг, консультации, обслуживание,
  ремонт, юридические и аудиторские услуги; сюда НЕ входят оплата труда, аренда,
  коммунальные услуги, налоги, проценты и страхование;
- capex — капитальные затраты: приобретение и создание основных средств,
  капитализированные работы, передача оборудования;
...
- other — операция не относится ни к одной из статей выше.
...
- знак суммы важен: полученный возврат, скидка или зачёт по статье — не расход по
  ...
  выручка;
- относи по существу операции, а не по совпадению слова в описании;
