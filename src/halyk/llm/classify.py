...
- principal_repayment — погашение основной суммы заёмных средств по графику или
  досрочно. Проценты сюда НЕ входят, они остаются процентными расходами;
- marketing — маркетинг и реклама в любом виде: медийные закупки, рекламные кампании,
  производство рекламных материалов, аренда рекламных площадей, спонсорство;
- other — операция не относится ни к одной из статей выше. Сюда идут
  консультационные, юридические и аудиторские услуги, прочие административные и
  сбытовые расходы, а также полученные возвраты и скидки.
